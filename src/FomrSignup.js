...
const FomrSignup = ({submitForm}) => {
    const {handleChange,values,handleSubmit,errors} = useForm(submitForm,validate);
    return (
        <div className="form-content-right">
            <form className="form" onSubmit={handleSubmit}>
                <h1>Get stated with us today!Greate your account by filling out the information below.</h1>
                ...
                <span className="form-input-login">Alrewady have an account ? Login <a href="#">here</a></span>
            </form>
        </div>
    )
}
